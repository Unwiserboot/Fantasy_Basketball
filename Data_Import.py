#!/Users/ccm/Documents/anaconda3/bin/python
...
preseason_traditional_data = response.json()['resultSets'][0][
    'rowSet']  # Website data
preseason_traditional_header = response.json()['resultSets'][0][
    'headers']  # Header abbreviation
